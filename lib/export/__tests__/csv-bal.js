...
test('exportAsCsv', async t => {
  ...
  const expected = `cle_interop;uid_adresse;voie_nom;lieudit_complement_nom;numero;suffixe;commune_insee;commune_nom;commune_deleguee_insee;commune_deleguee_nom;position;long;lat;x;y;source;date_der_maj
