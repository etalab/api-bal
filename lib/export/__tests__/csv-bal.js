...
test('createRow', t => {
  t.deepEqual(createRow({
    ...
    lieudit_complement_nom: 'Le Hameau',
    numero: '12',
    suffixe: 'bis',
    commune_insee: '54084',
...
test('exportAsCsv', async t => {
  ...
  const expected = `cle_interop;uid_adresse;voie_nom;lieudit_complement_nom;numero;suffixe;commune_insee;commune_nom;commune_deleguee_insee;commune_deleguee_nom;position;long;lat;x;y;cad_parcelles;source;date_der_maj
...
54084_a100_99999;;rue des aulnes;Le Hameau;99999;;54084;Mont-Bonvillers;;;;;;;;;;2019-01-05`.replace(/\n/g, '\r\n') + '\r\n'
  t.is(csv, expected)
})
